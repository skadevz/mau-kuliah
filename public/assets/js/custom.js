...
function prosesSubmitBanding(urlAct,token) {
    ...
    //     Swal.fire({
    //         type: 'error',
    //         text: 'Daftar perbandingan tidak adaa'
    //     });
    //     return false;
    // }
    ...
    //     Swal.fire({
    //         type: 'error',
    //         text: 'Daftar perbandingan tidak adab'
    //     });
    //     return false;
    // }else if ($.cookie('compare_univ_id') == undefined) {
    //     Swal.fire({
    //         type: 'error',
    //         text: 'Daftar perbandingan tidak adac'
    //     });
    //     return false;
    // }
    ...
    //     Swal.fire({
    //         type: 'error',
    //         text: 'Daftar perbandingan tidak adad'
    //     });
    //     return false;
    // }

    var data_id_universitas = $.parseJSON($.cookie('compare_univ_id'));
    if (data_id_universitas.length === 0) {
        Swal.fire({
            type: 'error',
            text: 'Daftar perbandingan tidak adad'
        });
    ...
    $.redirect(urlAct, {'_token': token, 'var_id_universitas': data_id_universitas});
}
